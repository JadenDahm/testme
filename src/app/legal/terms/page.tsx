  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface-0">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold mb-8 text-text-primary">Nutzungsbedingungen</h1>
        <div className="prose-dark max-w-none space-y-4">
          <h2 className="text-xl font-semibold text-text-primary mt-8">1. Geltungsbereich</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary mt-8">2. Erlaubte Nutzung</h2>
          <p className="text-text-secondary leading-relaxed">
            Die Plattform darf ausschließlich zum Testen <strong className="text-text-primary">eigener Websites und Domains</strong> verwendet werden.
          ...
          <h2 className="text-xl font-semibold text-text-primary mt-8">3. Art der Scans</h2>
          <p className="text-text-secondary leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-text-primary mt-8">4. Zustimmung</h2>
          <p className="text-text-secondary leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-text-primary mt-8">5. Protokollierung</h2>
          <p className="text-text-secondary leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-text-primary mt-8">6. Haftungsausschluss</h2>
          <p className="text-text-secondary leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-text-primary mt-8">7. Kündigung</h2>
          <p className="text-text-secondary leading-relaxed">
