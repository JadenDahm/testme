    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-4 text-gray-700">
          <h2 className="text-xl font-semibold text-gray-900 mt-8">1. Verantwortlicher</h2>
          <p>
            Verantwortlich für die Datenverarbeitung auf dieser Website ist der Betreiber der TestMe Security Plattform.
          </p>

          <h2 className="text-xl font-semibold text-gray-900 mt-8">2. Welche Daten erfassen wir?</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">3. Zweck der Datenverarbeitung</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">4. Hosting & Drittanbieter</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">5. Scan-Daten</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">6. Deine Rechte</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-gray-900 mt-8">7. Kontakt</h2>
          <p>
